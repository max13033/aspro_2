...
$(document).ready(function(){
	...
	/*$('.fancy').fancybox({
		...
		afterShow : function() {				
			$(".fancybox-overlay").append('<a title="'+BX.message('FANCY_CLOSE')+'" class="fancybox-item fancybox-close" style="top:10px;right:10px;z-index: 8050;" href="javascript:;" onclick="$.fancybox.close();"></a>');
			$(".fancybox-overlay").append('<a title="'+BX.message('FANCY_NEXT')+'" class="fancybox-nav fancybox-next" style="z-index: 9999;" href="javascript:;" onclick="$.fancybox.next()"><span style="visibility: visible;"></span></a>');
			$(".fancybox-overlay").append('<a title="'+BX.message('FANCY_PREV')+'" class="fancybox-nav fancybox-prev" style="z-index: 9999;" href="javascript:;" onclick="$.fancybox.prev();"><span style="visibility: visible;"></span></a>');
			
			var ww=$(window).width();
			var wh=$(window).height();
			var iw=$(".custom-fancy").width();
			var ih=$(".custom-fancy").height();
			$(".custom-fancy").css({"top":"39px","left":((ww-iw)/2+14)+"px"});
			if(ww<1025){
				$(".custom-fancy").css({"top": (wh-ih)/2-30+"px"});		
			}			
        }
	});*/
