...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH" => SITE_DIR."include/mainpage/adv_banner.php",
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "",
		"AREA_FILE_RECURSIVE" => "Y",
		"EDIT_TEMPLATE" => "standard.php"
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		"COMPONENT_TEMPLATE" => ".default",
		"PATH" => SITE_DIR."include/mainpage/adv_banner1.php",
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "",
		"AREA_FILE_RECURSIVE" => "Y",
		"EDIT_TEMPLATE" => "standard.php",
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PATH" => SITE_DIR."include/mainpage/comp_banners_float_custom.php",
		"AREA_FILE_SHOW" => "file",
		"AREA_FILE_SUFFIX" => "",
		"AREA_FILE_RECURSIVE" => "Y",
		"EDIT_TEMPLATE" => "standard.php",
		"HIDE_ON_MOBILE" => "Y",
		"TITLE_OF_BLOCK" => "Готовые решения интерьеров:",
		"COMPOSITE_FRAME_MODE" => "A",
		"COMPOSITE_FRAME_TYPE" => "AUTO"
	),
	false,
...
<?$APPLICATION->IncludeComponent("bitrix:main.include", "basket", array(
