...
BX.Catalog.SetConstructor = (function()
{
	var SetConstructor = function(params)
	{
		...
		this.updateCountProductInSet();
	};

    SetConstructor.prototype.updateCountProductInSet = function(){

    	var this_ = this;

        for (productID in arBasketAspro.BASKET) {
            $('.js-set-basket-'+productID).removeClass('hidden')
            $('.bx-constructor-result-btn-container a[data-item="'+productID+'"]').hide()
        }

        $(document).on("change keyup", ".counter_block input[type=text].js-update-catalog_set_constructor", function(e){

            var $element = $(this)
            var $product = $(this).parents('tr')

            $product.attr('data-quantity', $element.val())

            this_.itemsRatio[$product.attr('data-id')] = $product.attr('data-quantity')
	...
	SetConstructor.prototype.deleteFromSet = function()
	{
		...
		if (target && target.hasAttribute('data-role') && target.getAttribute('data-role') == 'set-delete-btn')
		{
            ...
            itemSetItem = item.getAttribute("data-set-item");
					...
					children: [
						...
						BX.create("td", {
							...
							children: [
							    BX.create("div", {
							        attrs:{
                                        className: "bx-added-item-table-cell-price-wrapper"
                                    },
                                    children: [
                                        BX.create("div", {
                                            children: [
                                        ...
                                        BX.create("div", {
                                            attrs: {
                                                className:"bx-added-item-table-margin-x",
                                            },
                                            text:"X"
                                        }),
                                        BX.create("div", {
                                            attrs: {
                                                className:"counter_wrapp",
                                            },
                                            children:[
                                                BX.create("div", {
                                                    children:[
                                                        BX.create("div", {
                                                            ...
                                                            children:[
                                                                ...
                                                                BX.create('input',{
                                                                    attrs:{
                                                                        type:"text",
                                                                        className:"text js-update-catalog_set_constructor",
                                                                        "data-set-count":"on",
                                                                        id:"on",
                                                                        name:"quantity",
                                                                        value: itemBasketQuantity,
                                                                    },
                                                                    text: "-"
                                                                }),
                                                                BX.create('span', {
	...
	SetConstructor.prototype.recountPrice = function()
	{
        ...
        $(this.setDiffPriceCont)
            .parents('.panel-default')
            .find('.b-projects-accordion__price>span')
            .html(
                BX.Currency.currencyFormat(sumPrice, this.currency, true)
            )
        ...
        console.log(this.setDiffPriceCont)
	...
	SetConstructor.prototype.addToBasket = function()
	{
        ...
        this.setIds.forEach(function(v){
            markProductAddBasket(v)
		})
		$('.js-set-basket-'+$(target).data('item')).removeClass('hidden')
        $(target).hide()
