...
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	...
	<div class="maxwidth-custom_banner">
    	<div class="custom_banner" style="background:url('/images/banner_bkgr.jpg') no-repeat 100%;background-size: 100%;">
			<h1 class="banner_text"><?$APPLICATION->IncludeFile(SITE_DIR."include/banner_text.php");?></h1>
    	</div></div>
	<?endif;?>
