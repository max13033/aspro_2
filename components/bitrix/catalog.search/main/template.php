	...
	if(!strlen($searchQuery))
        ...
        if (hasDev()){
            ...
            curl_setopt_array($myCurl, array(
                ...
                CURLOPT_POST => true,
                CURLOPT_POSTFIELDS => http_build_query(array('text'=> $searchQuery))
            ));
            ...
            if (is_array($response) && count($response)){
                ...
                foreach ($response as $word){
                    ...
                    $newQuery = str_replace($word->word, $word->s[0], $searchQuery);

                }

                echo "Возможно вы имели ввиду: <a style='text-decoration: underline; font-weight: 600; font-size: 18px;' href='/catalog/?q=$newQuery&how=r'>$newQuery</a> <br /> <br />";
            }
